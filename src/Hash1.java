//Author: Cobey Kromer
//Date: 11/29/2021
///Description: Hash Table 1 Class
public class Hash1 implements ListInterface
{
	//data holders
	long refChanges;
	long keyCompare;
	...
	{
		//int to hold the hash value
		int hash = 0;
		//iterate through the word and add the char value of each then take the mod256 of that number
		for(int i = 0; i < word.length(); i++)
		{
			hash += word.charAt(i); 
		}
		
		//return the mod of hash
		return (hash & 255); 
	}
